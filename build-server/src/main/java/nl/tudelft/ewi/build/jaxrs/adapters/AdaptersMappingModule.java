...
public class AdaptersMappingModule extends SimpleModule {
	...
	private void addCustomSourceDeserialization(SimpleDeserializers deserializers) {
		...
		Class<AdaptedDirectoryPreparer> modelClass = AdaptedDirectoryPreparer.class;

		IOBuilder<AdaptedDirectoryPreparer, Source.Type> io = IOBuilder.builder(typeClass, modelClass)
				.defineType(Source.Type.GIT, AdaptedGitDirectoryPreparer.class);
	...
	private void addCustomBuildInstructionDeserialization(SimpleDeserializers deserializers) {
		...
		Class<AdaptedBuildInstruction> modelClass = AdaptedBuildInstruction.class;

		IOBuilder<AdaptedBuildInstruction, BuildInstruction.Type> io = IOBuilder.builder(typeClass, modelClass)
				.defineType(BuildInstruction.Type.MAVEN, AdaptedMavenBuildInstruction.class);
